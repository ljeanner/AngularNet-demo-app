...
export class WeatherService {
  ...
  private fahrenheitToCelsius(fahrenheit: number): number {
      ...
      return (fahrenheit - FAHRENHEIT_FREEZING_POINT) * FAHRENHEIT_TO_CELSIUS_RATIO;
  }
